...
/* - input-label.js - */
// http://se.math.spbu.ru/SE/portal_javascripts/input-label.js?original=1
...
/* - fckeditor.js - */
// http://se.math.spbu.ru/SE/portal_javascripts/fckeditor.js?original=1
...
/* - fck_plone.js - */
// http://se.math.spbu.ru/SE/portal_javascripts/fck_plone.js?original=1
var FCKBaseHref={};makeLinksRelative=function(basehref,contents){var base=basehref.replace('http://se.math.spbu.ru','');var href=base.replace(/\/[^\/]*$/,'/');var hrefparts=href.split('/');return contents.replace(/(<[^>]* (?:src|href)=")([^"]*)"/g,
function(str,tag,url,offset,contents){url=url.replace('http://se.math.spbu.ru','');if(url.substring(0,1)=='#'){str=tag+url+'"'}
